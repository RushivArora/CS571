  ...
  .style("opacity",1)
        ...
        function wrap(text, width) {
           ...
           desc.append("text")
             ...
             .attr("fill", "black")
             .attr('font-size', 16)
             .text("This visualisation displays the distribution of vaccination progress over time in all the \
              countries in the world. The period of time covered in this visualisation is 01/01/2020 - 04/13/2021.")
              .call(wrap, 1200);
