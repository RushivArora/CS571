...
function ready(error, data) {
  ...
  .text(function(d) { return d.key; });
    ...
    .call(d3.drag()
      ...
      .on("end",function(){doneSliding(x.invert(d3.event.x));}));
    ...
    .call(yAxis);
      ...
      legendCircle.data(sumstat2.reverse())
      .enter()
      .append("circle")
      .transition()
      .duration(2000)
